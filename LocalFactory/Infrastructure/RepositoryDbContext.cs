...
public class RepositoryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //Seed data / Seeding 
        //Customer
        var customer1 = new Customer { Id = 1, CustomerName = "John", Email = "John123@gmail.com"};
        var customer2 = new Customer { Id = 2, CustomerName = "Bo", Email = "Bo123@gmail.com"};
        var customer3 = new Customer { Id = 3, CustomerName = "Mikkel", Email = "Mikkel123@gmail.com"};
        var customer4 = new Customer { Id = 4, CustomerName = "Ib", Email = "Ib123@gmail.com"};
        var customer5 = new Customer { Id = 5, CustomerName = "Ole", Email = "Ole123@gmail.com"};
